...
AI-native engineering delegates mechanical SDLC work to coding agents while engineers retain product intent, architecture, security, quality, and final operational accountability.

## Compiled Truth
- Capability shift: coding agents moved from autocomplete to multi-step agents with unified repo context, structured tool execution, persistent project memory, and evaluation loops.
- Planning: agents can map specs to code, identify dependencies, split tickets, deduplicate requests, and surface edge cases; humans own priority, sequencing, tradeoffs, and estimates.
- Design: multimodal agents can turn design artifacts into scaffolds and component candidates; engineers preserve design-system coherence, UX judgment, architecture, and domain constraints.
...
## Open Threads
- Define which Clous engineering workflows are agent-owned, agent-assisted, or human-only.
- Add examples of gold-standard PRs, test coverage, and incident diagnostics before scaling autonomous coding workflows.
