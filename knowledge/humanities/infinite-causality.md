...
- Iterate the *problem* least — it anchors an entire organization's direction
- Attack *root causes* — creates competitive moats and barriers to entry
- Sell against *consequences* — these are visible and felt right now, making them the easiest entry point
- Match messaging to awareness: if the audience doesn't know the problem, start from causes; if they know consequences, go straight to the problem
